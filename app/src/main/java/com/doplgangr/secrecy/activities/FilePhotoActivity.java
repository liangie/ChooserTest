...
import com.liangei.choosertest.R;
...
public class FilePhotoActivity extends FragmentActivity {
    ...
    public void onEventMainThread(ImageLoadDoneEvent event) {
        ...
        if (event.bitmap == null) {
            Util.alert(context,
                    "out of memory",
                    "Seems like your device does not have enough power to house that much info. Please select a smaller maximal image size in the settings.",
